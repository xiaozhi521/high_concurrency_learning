 ...
 *  直接作用于静态方法
 */
public class Synchronize_2_7_3 implements Runnable{
    static Synchronize_2_7_3 instance = new Synchronize_2_7_3();
    ...
    public static void main(String[] args) throws InterruptedException {
        Thread t1 = new Thread(new Synchronize_2_7_3());
        Thread t2 = new Thread(new Synchronize_2_7_3());
        t1.start();
        t2.start();
        t1.join();
        t2.join();
